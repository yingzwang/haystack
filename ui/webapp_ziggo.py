...
DEFAULT_QUESTION_AT_STARTUP = os.getenv("DEFAULT_QUESTION_AT_STARTUP", "Where should I put the WiFi pod in the house?")
...
def main():
    ...
    st.set_page_config(page_title='Question Answering Demo', page_icon="🤗")
    ...
    # Title
    st.write("# Question Answering Demo 🤗")
#     st.markdown("""
